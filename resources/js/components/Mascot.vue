...
<template>
    <div>
        <h1 class="font-normal text-3xl text-grqy-800 leading-none mb-12">
            Meet "Lary"
        </h1>
        ...
        <div class="flex mb-12">
            <div class="mr-8 flex flex-col items-center">
                ...
                <a href="/images/mascot/larydefault.svg" class="border border-grey-light px-8 py-2 rounded-full text-black font-bold text-xs">
                    larydefault.svg
                </a>
            </div>
        ...
        <div class="flex">
            ...
            <div
                ...
                class="border bordeay-300 rounded-lg flex flex-col items-center justify-center pt-6 pb-6 px-8 mr-6"
            >
                ...
                <a
                    ...
                    class="text-gray-400 text-xs hover:underline mt-auto"
                >larypeek.svg</a
                >
            </div>
            ...
            <div
                style="width: 153px; height: 219px;"
                class="border border-gray-300 rounded-lg flex flex-col items-center justify-center pt-6 pb-6 px-8 mr-6"
            >
            ...
            <div
                style="width: 153px; height: 219px;"
                class="border border-gray-300 rounded-lg flex flex-col items-center justify-center pt-6 pb-6 px-8"
            >

<template>
    <div>
        <h1 class="font-normal text-3xl text-grqy-800 leading-none mb-8">Open Sans</h1>

        <div class="rounded-lg bg-grey-lightest py-12 px-16 mb-10" style="max-width: 522px">
            ...
            <div class="flex justify-between mb-6">
                <strong class="text-xl font-semibold">Open Sans Semi Bold</strong>
        ...
        <div class="rounded-lg bg-black text-white py-12 px-16 mb-8" style="max-width: 522px">
            <div class="flex justify-end mb-10 items-center">

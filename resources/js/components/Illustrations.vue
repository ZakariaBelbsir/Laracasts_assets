<template>
    <div>
        ...
        <div class="flex mb-12">
            <picture
                class="rounded-lg bg-blue-500 py-6 px-10 mr-10 flex-1 flex justify-center items-center"
            >
                <img
            ...
            <div style="flex: 1.4">
                ...
                <p
                    class="leading-relaxed text-gray-500 text-sm mb-8 font-light"
                >
                    Learning isn’t easy. Keep your mind clear and don’t fill it
                    with expectations. Sponge brain is the best brain.
                </p>

                <a href="/images/illustrations/clarity.svg" class="border border-grey-light px-8 py-2 rounded-full text-black font-bold text-xs">
                    clarity.svg
                </a>
            </div>
        </div>
        ...
        <div class="flex mb-12">
            <picture
                class="rounded-lg bg-blue-500 py-6 px-10 mr-10 flex flex-1 justify-center items-center"
            >
                <img
            ...
            <div style="flex: 1.4">
                ...
                <a href="/images/illustrations/fun.svg" class="border border-grey-light px-8 py-2 rounded-full text-black font-bold text-xs">
                    fun.svg
                </a>
            </div>
        </div>
        ...
        <div class="flex mb-12">
            ...
            <div style="flex: 1.4">
                ...
                <a href="/images/illustrations/experiment.svg"
            ...
            <div style="flex: 1.4">
                ...
                <a href="/images/illustrations/strength.svg"
                   class="border border-grey-light px-8 py-2 rounded-full text-black font-bold text-xs">
                    strength.svg
                </a>
            </div>
        ...
        <div class="flex mb-12">
            ...
            <div style="flex: 1.4">
                ...
                <a href="/images/illustrations/information.svg" class="border border-grey-light px-8 py-2 rounded-full text-black font-bold text-xs">
                    information.svg
                </a>
            </div>
        </div>

...
var render = function() {
  ...
  return _c("div", [
    _c(
      "h1",
      {
        staticClass: "font-normal text-3xl text-grqy-darkest leading-none mb-8"
      },
    ...
    _c(
      ...
      {
        staticClass:
          "border border-gray-500 px-8 py-2 rounded-full text-black font-bold text-xs",
        attrs: { href: "/images/laracasts-spinner.zip" }
      },
      [_vm._v("spinner.zip")]
    )
  ])
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("p", { staticClass: "mb-10 text-gray-500 leading-normal" }, [
